package com.htxtdshopping.htxtd.frame.widget.cropimage;
 ...
 * @author chenzhipeng
 */
public class CropZoomImageView extends AppCompatImageView implements OnScaleGestureListener, OnTouchListener,
        ...
        mGestureDetector = new GestureDetector(context, new SimpleOnGestureListener() {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                ...
                if (getScale() < SCALE_MID) {
                    CropZoomImageView.this.postDelayed(new AutoScaleRunnable(SCALE_MID, x, y), 16);
                    isAutoScale = true;
                } else {
                    CropZoomImageView.this.postDelayed(new AutoScaleRunnable(initScale, x, y), 16);
                    isAutoScale = true;
                }
    ...
    public void onGlobalLayout() {
        if (once) {
            ...
            if (rectF.left < mHorizontalPadding) {
                deltaX = mHorizontalPadding - rectF.left;
            }
            if (rectF.top < mVerticalPadding) {
                deltaY = mVerticalPadding - rectF.top;
            }
    ...
    public Bitmap crop() {
        ...
        draw(canvas);
        return ImageUtils.clip(bitmap, mHorizontalPadding, mVerticalPadding,
