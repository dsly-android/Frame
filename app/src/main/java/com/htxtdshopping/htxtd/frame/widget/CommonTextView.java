...
public class CommonTextView extends RelativeLayout {
    ...
    private int defaultHintColor = 0xFFE8E8E8;
    //分割线默认颜色
    private int defaultDividerLineColor = 0xFFE8E8E8;
    private int rightDefaultSize;
    private int centerDefaultSize;
    //默认字体大小
    private int leftDefaultSize;
    //默认drawablePadding边距
    ...
    private int mLeftImageViewHeight;
    private int mLeftImageViewWidth;
    private int mRightImageViewHeight;
    private int mRightImageViewWidth;
    ...
    private CharSequence mCenterHintString;
    ...
    private String mRightHintTextString;
    ...
    private void getAttr(AttributeSet attrs) {
        ...
        mLeftImageViewHeight = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cLeftImageViewHeight, ViewGroup.LayoutParams.WRAP_CONTENT);
        mLeftImageViewWidth = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cLeftImageViewWidth, ViewGroup.LayoutParams.WRAP_CONTENT);
        mRightImageViewHeight = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cRightImageViewHeight, ViewGroup.LayoutParams.WRAP_CONTENT);
        mRightImageViewWidth = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cRightImageViewWidth, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        mCenterHintString = typedArray.getString(R.styleable.CommonTextView_cCenterHintString);
        ...
        mRightHintTextColor = typedArray.getColor(R.styleable.CommonTextView_cRightHintTextColor, defaultHintColor);

        mRightHintTextString = typedArray.getString(R.styleable.CommonTextView_cRightHintTextString);

        mLeftTextSize = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cLeftTextSize, leftDefaultSize);
        mLeftTopTextSize = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cLeftTopTextSize, leftDefaultSize);
        mLeftBottomTextSize = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cLeftBottomTextSize, leftDefaultSize);

        mCenterTextSize = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cCenterTextSize, centerDefaultSize);
        mCenterTopTextSize = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cCenterTopTextSize, centerDefaultSize);
        mCenterBottomTextSize = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cCenterBottomTextSize, centerDefaultSize);

        mRightTextSize = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cRightTextSize, rightDefaultSize);
        mRightTopTextSize = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cRightTopTextSize, rightDefaultSize);
        mRightBottomTextSize = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cRightBottomTextSize, rightDefaultSize);
        ...
        mLeftViewPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cLeftViewPaddingLeft, defaultPaddingLR);
        ...
        mRightViewPaddingRight = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cRightViewPaddingRight, defaultPaddingLR);
        ...
        mLeftImageViewMarginLeft = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cLeftImageViewMarginLeft, defaultPaddingLR);
        mRightImageViewMarginRight = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cRightImageViewMarginRight, defaultPaddingLR);
        ...
        mDividerLineHeight = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cDividerLineHeight, 2);

        useSelector = typedArray.getBoolean(R.styleable.CommonTextView_cUseSelector, true);
    ...
    private void init() {
        ...
        if (mCenterHintString != null || mCenterTextString != null) {
            initCenterText();
        }
    ...
    private void initCommonTextView() {
        ...
        if (useSelector) {
            this.setBackgroundResource(R.drawable.bg_press_effect);
        }
    ...
    private void initLineView() {
        if (topLineView != null) {
            removeView(topLineView);
        }
        if (bottomLineView != null) {
            removeView(bottomLineView);
        }
     ...
     * 设置分割线的style
     */
    public void setDividerLineType(int type) {
    ...
    private void initLeftImageView() {
        ...
        leftIVParams = new LayoutParams(mLeftImageViewWidth, mLeftImageViewHeight);
    ...
    private void initRightImageView() {
        ...
        rightIVParams = new LayoutParams(mRightImageViewWidth, mRightImageViewHeight);
    ...
    private void initCenterText() {
        if (centerTextView == null) {
            ...
            if (mCenterTextViewGravity == Gravity_Left_Center) {
                centerTVParams.addRule(RelativeLayout.LEFT_OF, R.id.cRightImageViewId);
                centerTVParams.addRule(RelativeLayout.LEFT_OF, R.id.cRightTextId);
                centerTVParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT, TRUE);
            } else if (mCenterTextViewGravity == Gravity_Center) {
            ...
            if (mCenterHintString != null) {
                centerTextView.setHint(mCenterHintString);
            }
    ...
    private void initRightText() {
        if (rightTextView == null) {
            ...
            rightTVParams.setMargins(0, 0, mRightViewPaddingRight, 0);
            rightTextView = initText(rightTextView, rightTVParams, R.id.cRightTextId, mRightTextColor, mRightTextSize);
            rightTextView.setHintTextColor(mRightHintTextColor);
            rightTextView.setHint(mRightHintTextString);
...
//            textView.setFilters(new InputFilter[]{new InputFilter.LengthFilter(mSetMaxEms)});
    ...
    public void setLeftIVdrawableRes(int drawableRes) {
        mLeft_IV_drawable = getResources().getDrawable(drawableRes);
