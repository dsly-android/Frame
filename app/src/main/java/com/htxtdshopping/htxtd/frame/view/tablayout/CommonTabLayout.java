...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mUnderlineHeight = ta.getDimension(R.styleable.CommonTabLayout_tl_underline_height, 0);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mIconGravity == Gravity.LEFT) {
                tabView = View.inflate(mContext, R.layout.tab_common_left, null);
            } else if (mIconGravity == Gravity.RIGHT) {
                tabView = View.inflate(mContext, R.layout.tab_common_right, null);
            } else if (mIconGravity == Gravity.BOTTOM) {
                tabView = View.inflate(mContext, R.layout.tab_common_bottom, null);
            } else {
                tabView = View.inflate(mContext, R.layout.tab_common_top, null);
            }
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setTextUnselectSize(float textUnselectSize) {
        this.mTextUnselectSize = textUnselectSize;
        updateTabStyles();
    }
