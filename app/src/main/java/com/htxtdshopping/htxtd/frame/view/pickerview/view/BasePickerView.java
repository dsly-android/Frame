...
import com.htxtdshopping.htxtd.frame.view.pickerview.listener.OnDismissListener;
import com.htxtdshopping.htxtd.frame.view.pickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    public void createDialog() {
        if (dialogView != null) {
            mDialog = new Dialog(context, R.style.AppTheme_Dialog);
            mDialog.setCancelable(mPickerOptions.cancelable);//不能点外面取消,也不能点back取消
            mDialog.setContentView(dialogView);

            Window dialogWindow = mDialog.getWindow();
            if (dialogWindow != null) {
                dialogWindow.setWindowAnimations(R.style.window_animation_bottom);
