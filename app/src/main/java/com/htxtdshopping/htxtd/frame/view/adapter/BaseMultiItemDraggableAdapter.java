package com.htxtdshopping.htxtd.frame.view.adapter;
 ...
 * @date 2019/1/16
 */
public abstract class BaseMultiItemDraggableAdapter<T extends MultiItemEntity, K extends BaseViewHolder> extends BaseItemDraggableAdapter<T, K> {
    ...
    public BaseMultiItemDraggableAdapter(List<T> data) {
        super(data);
    }
