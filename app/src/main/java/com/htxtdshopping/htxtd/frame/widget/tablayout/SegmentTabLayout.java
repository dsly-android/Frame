package com.htxtdshopping.htxtd.frame.widget.tablayout;
...
import com.htxtdshopping.htxtd.frame.widget.tablayout.utils.FragmentChangeManager;
...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorStartColor = ta.getColor(R.styleable.SegmentTabLayout_tl_indicator_start_color, mIndicatorColor);
        mIndicatorEndColor = ta.getColor(R.styleable.SegmentTabLayout_tl_indicator_end_color, mIndicatorColor);
        ...
        mIndicatorMarginLeft = ta.getDimension(R.styleable.SegmentTabLayout_tl_indicator_margin_left, 0);
        mIndicatorMarginTop = ta.getDimension(R.styleable.SegmentTabLayout_tl_indicator_margin_top, 0);
        mIndicatorMarginRight = ta.getDimension(R.styleable.SegmentTabLayout_tl_indicator_margin_right, 0);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.tab_segment, null);
            tabView.setTag(i);
            addTab(i, tabView);
        }
